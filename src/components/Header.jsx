...
export default function Header({ onAdd, onSignOut, onRefresh, view, onViewChange, theme, onThemeToggle, userName }) {
  return (
    <header className="header">
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px' }}>
        <h1>Gig Tracker</h1>
        <a
          href="https://docs.google.com/spreadsheets/d/1hxIg6jAjB1ki6eqRlQFsl2K7nuYH3BVH5g7n-DQDUYM/edit?gid=1166941567#gid=1166941567"
          target="_blank"
